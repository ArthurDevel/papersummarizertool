  ...
  return (
    <main className="w-full">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Listing contents of <span className="font-mono">preloaded_papers/</span>.</p>
        ...
        {isLoading ? (
          ...
          <div className="text-gray-600 dark:text-gray-300">No papers found. Add JSON files to <span className="font-mono">preloaded_papers/</span>.</div>
        ) : (
